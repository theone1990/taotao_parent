...
import com.taotao.mapper.TbTypeTemplateMapper;
import com.taotao.pojo.TbTypeTemplate;
import com.taotao.pojo.TbTypeTemplateExample;
import com.taotao.pojo.TbTypeTemplateExample.Criteria;
...
public class TypeTemplateServiceImpl implements TypeTemplateService {
    ...
    public List<Map> findSpecList(Long id) {
		...
		for (Map spec : list) {
			...
			example.createCriteria().andSpecIdEqualTo(new Long((Integer)spec.get("id")));
